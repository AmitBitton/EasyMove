...
public class SettingsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // ---- View Binding (חיבור ל-XML) ----
        switchNotifications = view.findViewById(R.id.switchNotifications); // ✅ קיים ב-XML
        switchDarkMode = view.findViewById(R.id.switchDarkMode);           // ✅ קיים ב-XML

        // כפתורים חדשים
        View btnContact = view.findViewById(R.id.btnContactSupport);       // ✅ קיים ב-XML
        View btnPrivacy = view.findViewById(R.id.btnPrivacyPolicy);        // ✅ קיים ב-XML
        ...
        // 3. צור קשר (שליחת אימייל)
        btnContact.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_SENDTO);
            intent.setData(Uri.parse("mailto:support@easymove.com")); // המייל שלך
        ...
        // 4. מדיניות פרטיות (פתיחת דפדפן או טוסט)
        btnPrivacy.setOnClickListener(v -> {
            // כאן אפשר לפתוח קישור לדפדפן, כרגע נשים רק הודעה
